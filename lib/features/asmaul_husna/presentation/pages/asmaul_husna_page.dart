...
import '../bloc/asmaul_husna_bloc.dart';
import '../bloc/asmaul_husna_event.dart';
import '../bloc/asmaul_husna_state.dart';
...
class _AsmaulHusnaPageState extends State<AsmaulHusnaPage> {
  List<AsmaulHusnaDataEntity> _allasmaulhusnas = [];
  List<AsmaulHusnaDataEntity> _filteredasmaulhusnas = [];
